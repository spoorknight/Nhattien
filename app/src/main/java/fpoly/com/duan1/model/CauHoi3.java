...
public class CauHoi3 implements Serializable {

    private String id,cauHoi,dapAnDung,dapAnSai1,dapAnSai2,dapAnSai3;

    public CauHoi3(String id, String cauHoi, String dapAnDung, String dapAnSai1, String dapAnSai2, String dapAnSai3) {
        this.id = id;
        this.cauHoi = cauHoi;
